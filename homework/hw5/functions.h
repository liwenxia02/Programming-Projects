...
void printnumandwords(std::string digraph, std::map<std::string,std::vector<std::string>> graphlist); //prints number of words the containing the digraph and all words inluding the digraph 
